...
import { getConfig } from '$stores/store_helpers';
	import { getPegWalletAddressFromPublicKey, type BridgeTransactionType } from '@mijoco/stx_helpers/dist/index';
...
<div class="">
  ...
  <div class="row">
    ...
    <div class="col-2">SBTC Wallet</div><div class="col-10">{getPegWalletAddressFromPublicKey(getConfig().VITE_NETWORK, $sessionStore.sbtcInfo.sbtcContractData.sbtcWalletPublicKey)}</div>
